 ...
 * This variation, with these parameters, is aimed at games with a high probability of 1-5 iterations.
 * If unlimited iterations, this means a probability of 0.7- of continuing.
 **********************************************************************************/
public class PermaDefectStrategy extends Strategy {

	private final int DEFECT_TOLERANCE = 0;
	private final double MIMIC_IF_DEFECT = 1;
	private final int MATCHES_TO_START_DEFECTING = 0;
